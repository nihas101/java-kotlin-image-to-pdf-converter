...
class RecursiveFileSearcherTest {
    ...
    fun searchRecursivelyKt() {
        val recursiveFileSearcher = createRecursiveFileSearcher(File("src/test/java/de/nihas101/image_to_pdf_converter/gui/controller"))
        ...
        val expectedDirectories = File("src/test/java/de/nihas101/image_to_pdf_converter/gui/controller").listFiles().filter { file -> file.extension == "png" }.toTypedArray()
